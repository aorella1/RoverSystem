...
public class DisplayApplicationController {
    ...
    public void initialize() {
        ...
        cameraImageView.setImage(new Image("camera/black.png"));
        cameraOverlay.setImage(new Image("camera/empty.png"));
        cameraOverlay.setOpacity(1);
    }

    public void updateBackgroundColor(Paint p) {
        root.setBackground(new Background(new BackgroundFill(p, null, null)));
    }

    public void updateCameraState(boolean working) {
        if (working) {
            cameraOverlay.setOpacity(0);
        } else {
            cameraOverlay.setOpacity(1);
        }
    }
